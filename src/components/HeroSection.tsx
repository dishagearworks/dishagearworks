      ...
      <div className="lg:grid lg:grid-cols-[54%_46%]">
        ...
        <div className="relative flex items-center px-5 py-12 sm:px-8 lg:py-20 lg:pl-6 lg:pr-12 xl:pr-20">
          ...
          >
            ...
            <motion.h1
              variants={item}
              className="mt-6 font-heading text-4xl font-bold leading-[1.05] tracking-tight text-navy sm:text-5xl xl:text-6xl"
            >
              Precision Agricultural Machinery{" "}
              <span className="text-gradient-orange">Components</span>{" "}
            ...
            <motion.span
              variants={item}
              className="mt-5 block h-0.5 w-16 rounded-full bg-orange-gradient"
            />
